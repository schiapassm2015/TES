 ...
 * either contained in a {@link SeccionListActivity} in two-pane mode (on
 * tablets) or a {@link SeccionDetailActivity} on handsets.
 */
public class SeccionDetailFragment extends Fragment {
	/**
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_seccion_detail,
				container, false);
