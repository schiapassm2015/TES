...
/**
 * Este es un adaptador genérico para mapear una lista de objetos contra 
 * widgets TextView que visualizarán los atributos definidos.
 * @author Axel
 *
 * @param <T>
 */
public class AdaptadorArrayGenerico<T> extends ArrayAdapter<T> {
	 ...
	 */
	public AdaptadorArrayGenerico(Context c, int layout, List<T> datos, String[] bindDeAtributo, int[] bindHaciaIdView ){
