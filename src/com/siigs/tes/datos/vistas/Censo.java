...
public class Censo {
	...
	private final static String SUBCONSULTA = "(select "+ControlVacuna.ID_VACUNA+" from "+ControlVacuna.NOMBRE_TABLA+" where "+ControlVacuna.ID_PERSONA+"=p."+Persona.ID+" and "+ControlVacuna.ID_VACUNA+"=";
