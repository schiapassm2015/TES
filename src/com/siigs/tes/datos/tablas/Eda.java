...
public class Eda {
	...
	public static List<Eda> getEdasActivas(Context context){
		Cursor cur = context.getContentResolver().query(
				ProveedorContenido.EDA_CONTENT_URI, null, ACTIVO + "=1", null, DESCRIPCION);
		List<Eda> salida = DatosUtil.ObjetosDesdeCursor(cur, Eda.class);
		cur.close();
		return salida;
	}
	
	public static String getDescripcion(Context context, int id){
		Uri uri = Uri.withAppendedPath(ProveedorContenido.EDA_CONTENT_URI, String.valueOf(id));
