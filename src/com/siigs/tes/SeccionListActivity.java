 ...
 * {@link SeccionDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link SeccionListFragment} and the item details (if present) is a
 * {@link SeccionDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link SeccionListFragment.Callbacks} interface to listen for item
 * selections.
 */
public class SeccionListActivity extends FragmentActivity implements
		SeccionListFragment.Callbacks {
	...
	private SeccionListFragment lfMenuIzquierdo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.seccion_detail_container) != null) {
			...
			lfMenuIzquierdo=(SeccionListFragment) getSupportFragmentManager()
	...
	/**
	 * Callback method from {@link SeccionListFragment.Callbacks} indicating
	...
	public void onItemSelected(String id) {
		if (enDosPaneles) {
			...
			arguments.putString(SeccionDetailFragment.ARG_ITEM_ID, id);
			...
			detailIntent.putExtra(SeccionDetailFragment.ARG_ITEM_ID, id);
